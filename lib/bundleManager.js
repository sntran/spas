...
/**
 * Bundle middleware factory. Returns bundle middleware which adds the bundle
 * definition to the context based on request's params and its internal list
 * of bundles loaded from a directiory.
 *
 * @param {Function} next
 * @return {Function}
 * @api public
